...
class FullcutGoods extends Model
{
	 ...
	 * @return             [列表数据]
	 */
	public function getFullcutGoodsList( $condition = [], $field = '*', $order = 'id desc', $page = [1, 20] )
	{
		if( $page == '' ){
	 ...
	 * @return
	 */
	public function getWithTrashedFullcutGoodsList( $condition = [], $field = '*', $order = 'id desc', $page = [1, 20] )
	{
	 ...
	 * @return
	 */
	public function getOnlyTrashedFullcutGoodsList( $condition = [], $field = '*', $order = 'id desc', $page = [1, 20] )
	{
	 ...
	 * @return
	 */
	public function getFullcutGoodsCount( $condition = [] )
	{
	 ...
	 * @return
	 */
	public function getFullcutGoodsInfo( $condition = [], $field = '*' )
	{
	 ...
	 * @return
	 */
	public function updateFullcutGoods( $condition = [], $update = [] )
	{
	 ...
	 */
	public function editMultiFullcutGoods( array $update )
	{

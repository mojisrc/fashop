...
class OrderRefund extends Model
{
	...
	public function addOrderRefund( array $refund_array, array $order = [], array $goods = [] )
	{
		if( !empty( $order ) && is_array( $order ) ){
			...
			$refund_array['out_request_no'] = $order['out_request_no']; //支付宝交易号OR微信交易号
	 ...
	 * @return
	 */
	public function getOrderRefundSum( $condition = [], $condition_str = '', $field = 'id' )
	{

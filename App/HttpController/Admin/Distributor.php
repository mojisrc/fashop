...
class Distributor extends Admin
{
    ...
    public function list()
    {
        ...
        $count             = $distributor_model->getDistributorCount($condition, $condition_str);
        $list              = $distributor_model->getDistributorList($condition, $condition_str, '*', 'id desc', $this->getPageLimit(), '');
